...
import { AreaChart, ResponsiveContainer, XAxis, YAxis, Tooltip, Area, Line, CartesianGrid, Legend, LineChart, BarChart, Bar  } from 'recharts';
        ...
        <DashboardBox bgcolor="#fff" gridArea="a">
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip />
              <Area type="monotone" dot={true} fillOpacity={1} dataKey="revenue" stroke={palette.primary.main} fill="url(#colorRevenue)" />
              <Area type="monotone" dot={true} fillOpacity={1} dataKey="expenses" stroke={palette.primary.main} fill="url(#colorExpenses)" />
            </AreaChart>
          </ResponsiveContainer>
        </DashboardBox>
        ...
        <DashboardBox bgcolor="#fff" gridArea="b">
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <XAxis dataKey="name" tickLine={false} style={{fontSize:"10px"}} />
              <YAxis tickLine={false} yAxisId="left" axisLine={false} style={{fontSize:"10px"}} />
              <YAxis tickLine={false} yAxisId="right" axisLine={false} style={{fontSize:"10px"}} orientation='right' />
