    ...
    <DashboardBox width="100%" height="100%" p="1rem" overflow="hidden">
        ...
        <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <YAxis tickFormatter={(v)=>`$${v}`} domain={[12000, 26000]} tickLine={false} axisLine={{strokeWidth: '0'}} style={{fontSize:"10px"}}>
              ...
              {isPredictions && (
              <Line strokeDasharray="5 5"  type="monotone" dataKey="Predicted Revenue" stroke={palette.secondary[500]} dot={true}  />
